...
*/
      ...
      $scope.ShowStore=function($rootScope,$http,$scope){
    ...
    $scope.bookmyvisit=function($rootScope,$http,$scope){
  ...
  //login function for login in user
	  $scope.loginUser=function(){
            ...
            if(response.status==200){
              ...
              sessionStorage.setItem("firstname",getData.FirstName);
              sessionStorage.setItem("lastname",getData.LastName);
              sessionStorage.setItem("email", getData.email);
              sessionStorage.setItem("contactno",getData.contactno);

            sessionStorage.setItem("x","true"); //setting value x =true in local browser storage for authenticating and fetching in redirected page controller.
